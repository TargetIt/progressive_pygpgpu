#!/bin/bash
# Phase 4: Scoreboard & Hazards -- one-click run script
set -e
...
if [ "$1" = "--trace" ]; then
    DEMO="${2:-tests/programs/01_raw_hazard.asm}"
    echo "--- Trace: $DEMO ---"
...
echo "╔══════════════════════════════════════════════╗"
echo "║  Phase 4: Scoreboard & Hazards Test Suite    ║"
echo "╚══════════════════════════════════════════════╝"
echo ""

PYTHONIOENCODING=utf-8 python tests/test_phase4.py
