#!/bin/bash
# Phase 7: Instruction Pipeline -- one-click run script
set -e
...
if [ "$1" = "--trace" ]; then
    DEMO="${2:-tests/programs/01_ibuffer_basic.asm}"
    echo "--- Trace: $DEMO ---"
...
echo "╔══════════════════════════════════════════════╗"
echo "║  Phase 7: Instruction Pipeline Test Suite    ║"
echo "╚══════════════════════════════════════════════╝"
echo ""

PYTHONIOENCODING=utf-8 python tests/test_phase7.py
